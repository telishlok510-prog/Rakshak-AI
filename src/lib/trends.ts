...
export interface ScamTrend {
  ...
  howItWorks: string;
  redFlag: string;
  category: string; // NEW: filterable category
}

/**
 * Curated "what's new in scams" feed with category tags for filtering.
 */
...
/** Category filter labels for the UI */
export const TREND_CATEGORIES: Record<LanguageCode, Record<string, string>> = {
  en: {
    all: "All",
    latest: "Latest Scams",
    "fake-kyc": "Fake KYC",
  ...
  gu: {
    all: "બધા",
    latest: "નવી છેતરપિંડીઓ",
    "fake-kyc": "નકલી KYC",
    upi: "UPI છેતરપિંડી",
    reward: "નકલી ઇનામ",
    job: "નોકરીની છેતરપિંડી",
    loan: "લોન છેતરપિંડી",
    qr: "QR છેતરપિંડી",
    investment: "રોકાણ છેતરપિંડી",
  },
};