...
export const SCAM_CALL_SCENARIOS: Record<LanguageCode, ScamCallScenario[]> = {
  en: [
    // English UI displays Gujarati audio files (no English audio available yet)
    {
      id: "bank-kyc-block-gu",
      title: {
        en: "Fake Bank KYC Call (Gujarati Audio)",
...
કૉલ કરનાર: હું તમને SMS પર લિંક મોકલીશ. તેને ખોલો અને ચકાસવા માટે તમારી ડેબિટ કાર્ડ વિગતો અને OTP દાખલ કરો.`,
    ...
    },
    {
      ...
      title: {
        en: "Digital Arrest Scam (Gujarati Audio)",
...
કૉલ કરનાર: જો તમે કોઈને કહેશો અથવા ડિસ્કનેક્ટ કરશો, તો અમે તરત જ ધરપકડ વોરંટ બહાર પાડીશું. લાઈન પર રહો.`,
    ...
    },
    {
      ...
      title: {
        en: "Fake Electricity Bill Scam (Gujarati Audio)",
      ...
      pausePoints: [
        {
          ...
          options: [
            "Yes, this happens for pending bills",
            "No, this is urgency tactic - real companies give advance notice",
        ...
        },
        {
          ...
          options: [
            "Yes, he's from electricity board",
            "No, never - real companies don't ask payment to personal numbers",
